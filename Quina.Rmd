...
for(i in 2:length(thetable$children))
{
   if (!is.null(thetable$children[[i]]$children$td$children$text$value)) {
     vConcurso <- c(vConcurso, thetable$children[[i]]$children$td$children$text$value)
...
dfquina <- data.frame(vConcurso, as.date(vDate), vDezena1, vDezena2, vDezena3, vDezena4, vDezena5)
```
